...
const SAVED_ADDRESSES = [
  { id: 1, label: 'Дом', street: 'ул. Абая 150', apartment: 'кв. 45', city: 'Алматы', icon: 'home' },
  { id: 2, label: 'Офис', street: 'пр. Достык 5', apartment: 'офис 301', city: 'Алматы', icon: 'business' },
];
